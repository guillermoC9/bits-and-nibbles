...
Just to let you know, the primitives ```Poly1305```, ```Shake128``` and ```Shake256``` are not a pure hash primitives, but the former is a HMAC algorithm and the latter are **H**ash-based **K**ey **D**erivation **F**unctions or HKDF. 
