...
/* Same as previous BUT with the font in memory (written by Guillermo Amodeo) */

LOCAL_DEF  TT_Error  TT_Open_Mem_Stream(const void *ptr,Long tam,TT_Stream *stream );
