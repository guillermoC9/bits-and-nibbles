...
In order to support the embedding of arbitrary TrueType font files, we also include part of an old version of the FreeType-1 library, actually version 1.4, which the authors of it (David Turner, Robert Wilhelm, and Werner Lemberg) let anyone use it under 3 conditions that we reporduce here:
