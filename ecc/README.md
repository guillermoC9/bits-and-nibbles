...
Before pictures were much bigger than the whole of Windows 95 (~30 Mb), people was really concerned about the size of ```RSA``` keys and the computational performance of the algorithm. So, they did something about it and divised a new criptography technique based on Finite Galois Fields, a very interesting part of computational geometry.  
